...
gets(a->departamento);
printf("Inngrese el sueldo del empleado: ");
scanf("%f", &a->sueldo);
fflush(stdin);
...
printf("\nDatos del empleados 1\n");
printf("%s\t%s\t%.2f\t%s\t%d\t%d\t%s", e1->nombre, e1->departamento, e1->sueldo, e1->direccion, e1->direccion.numero, e1->direccion.cp, e1->direccion.localidad);
